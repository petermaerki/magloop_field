...
ANTENNENDATEN = Antenna(
    ...
    powerPfwd_W=MAZZONI_BABY.powerPfwd_W,
    info_str=MAZZONI_BABY.info_str,
    info_environment_str=MAZZONI_BABY.info_environment_str,
    ...
    bands=[
        BandData(
            ...
            bw262_Hz=FloatText(
                4_000,
                "[MazzBaby] Datenblatt, Bandbreite 40m; Messkriterium unbekannt (kein SWR-Hinweis)",
            ),
        ...
        BandData(
            ...
            bw262_Hz=FloatText(
                6_000,
                "[MazzBaby] Datenblatt, Bandbreite 20m; Messkriterium unbekannt (kein SWR-Hinweis)",
            ),
            swr_min=FloatText(1.18, "[Annahme] Mazzoni: nicht perfekt anpassbar"),
        ),
        BandData(
            ...
            bw262_Hz=FloatText(
                12_000,
                "[MazzBaby] Datenblatt, Bandbreite 15m; Messkriterium unbekannt (kein SWR-Hinweis)",
            ),
            swr_min=FloatText(1.18, "[Annahme] Mazzoni: nicht perfekt anpassbar"),
        ),
        BandData(
            ...
            bw262_Hz=FloatText(
                20_000,
                "[MazzBaby] Datenblatt, Bandbreite 10m; Messkriterium unbekannt (kein SWR-Hinweis)",
            ),
            swr_min=FloatText(1.18, "[Annahme] Mazzoni: nicht perfekt anpassbar"),
        ),
    ],
    bandwidth_source_str=MAZZONI_BABY.bandwidth_source,
    bandwidth_source_tooltip_str=MAZZONI_BABY.bandwidth_source_tooltip_str,
)
